...
const LESSONS = [
  ...
  // UNIDAD 2: Familia M
  // ───────────────────────────────────────────
  { unit:2, unitTitle:'📚 Unidad 2 · Familia M', id:'ma_familia',
    icon:'👩', title:'MA · ME · MI · MO · MU', desc:'La familia de la M', game:'silabario', cons:'M',
    xp:25, diff:'easy', unlocks:['ma_silabas'] },
  { id:'ma_silabas',
    icon:'🔠', title:'Une Sílabas · M', desc:'MAMÁ, MONO, MUÑECA...', game:'silabas',
    xp:30, diff:'easy', unlocks:['pa_familia'] },

  // ───────────────────────────────────────────
  // UNIDAD 3: Familia P
  // ───────────────────────────────────────────
  { unit:3, unitTitle:'📚 Unidad 3 · Familia P', id:'pa_familia',
  ...
  // UNIDAD 4: Familia S
  // ───────────────────────────────────────────
  { unit:4, unitTitle:'📚 Unidad 4 · Familia S', id:'sa_familia',
    icon:'🐸', title:'SA · SE · SI · SO · SU', desc:'La familia de la S', game:'silabario', cons:'S',
    xp:25, diff:'easy', unlocks:['la_familia'] },

  // ───────────────────────────────────────────
  // UNIDAD 5: Familias L y T
  // ───────────────────────────────────────────
  { unit:5, unitTitle:'📚 Unidad 5 · Familias L y T', id:'la_familia',
  ...
  // ───────────────────────────────────────────
  // UNIDAD 7: Familias B y N
  // ───────────────────────────────────────────
  { unit:7, unitTitle:'📚 Unidad 7 · Familias B y N', id:'ba_familia',
  ...
  // ───────────────────────────────────────────
  // UNIDAD 8: Familias R y D
  // ───────────────────────────────────────────
  { unit:8, unitTitle:'📚 Unidad 8 · Familias R y D', id:'ra_familia',
    icon:'🌹', title:'RA · RE · RI · RO · RU', desc:'La familia de la R', game:'silabario', cons:'R',
    xp:30, diff:'medium', unlocks:['da_familia'] },
  { id:'da_familia',
    icon:'🎲', title:'DA · DE · DI · DO · DU', desc:'La familia de la D', game:'silabario', cons:'D',
    xp:30, diff:'medium', unlocks:['palabras_3'] },
  { id:'palabras_3',
    icon:'📜', title:'Leer Palabras III', desc:'RANA, DADO, DELFIN, ROSA...', game:'palabras', wordSet:'set3',
    xp:45, diff:'medium', unlocks:['fa_familia'] },

  // ───────────────────────────────────────────
  // UNIDAD 9: Familias F y G
  // ───────────────────────────────────────────
  { unit:9, unitTitle:'📚 Unidad 9 · Familias F y G', id:'fa_familia',
    icon:'🎊', title:'FA · FE · FI · FO · FU', desc:'La familia de la F', game:'silabario', cons:'F',
    xp:30, diff:'medium', unlocks:['ga_familia'] },
  { id:'ga_familia',
    icon:'🐱', title:'GA · GO · GU', desc:'La familia de la G', game:'silabario', cons:'G',
    xp:30, diff:'medium', unlocks:['palabras_4'] },
  { id:'palabras_4',
    icon:'📓', title:'Leer Palabras IV', desc:'FARO, GATO, FOTO, GOTA...', game:'palabras', wordSet:'set4',
    xp:45, diff:'medium', unlocks:['ca_familia'] },

  // ───────────────────────────────────────────
  // UNIDAD 10: Familia C + Repaso Grande
  // ───────────────────────────────────────────
  { unit:10, unitTitle:'📚 Unidad 10 · Familia C', id:'ca_familia',
    icon:'🏠', title:'CA · CO · CU', desc:'La familia de la C (como K)', game:'silabario', cons:'C',
    xp:35, diff:'medium', unlocks:['repaso_silabas'] },
  { id:'repaso_silabas',
    icon:'🔄', title:'Repaso de Sílabas', desc:'Practica todo lo aprendido', game:'silabafalta',
    xp:50, diff:'hard', unlocks:['repaso_palabras'] },
  { id:'repaso_palabras',
    icon:'💡', title:'Repaso de Palabras', desc:'¡Lee todo tipo de palabras!', game:'palabras', wordSet:'set5',
    xp:50, diff:'hard', unlocks:['repaso_iniciales'] },
  { id:'repaso_iniciales',
    icon:'🎯', title:'Repaso de Iniciales', desc:'¡Un reto con todas las letras!', game:'iniciales',
    xp:40, diff:'hard', unlocks:['diploma'] },

  // ───────────────────────────────────────────
  // UNIDAD 11: Diploma
  // ───────────────────────────────────────────
  { unit:11, unitTitle:'🎓 Unidad 11 · Maestro Lector', id:'diploma',
    icon:'🎓', title:'¡Maestro Lector!', desc:'¡Completaste todo el Nacho!', game:'diploma',
    xp:100, diff:'easy', unlocks:[] },
];
...
const PALABRAS_SETS = {
  ...
  set2: [
    ...
    {word:'POLO',   emoji:'🧊',distractors:['🍊','🐕','🌹']},
  ],
  set3: [
    {word:'RANA',   emoji:'🐸',distractors:['🐢','🌙','🎲']},
    {word:'DADO',   emoji:'🎲',distractors:['🐸','🌸','🚀']},
    {word:'ROPA',   emoji:'👕',distractors:['🍊','🐱','🌙']},
    {word:'DEDO',   emoji:'👆',distractors:['🎂','🐸','⭐']},
    {word:'NIDO',   emoji:'🪺',distractors:['🍌','🐕','🌹']},
    {word:'BODA',   emoji:'💍',distractors:['🐢','🌙','🎊']},
  ],
  set4: [
    {word:'FARO',   emoji:'🍯',distractors:['🐱','🚀','🍌']},
    {word:'GATO',   emoji:'🐱',distractors:['🐸','🍯','🌙']},
    {word:'FOTO',   emoji:'📸',distractors:['🌹','🎲','🚀']},
    {word:'GOTA',   emoji:'💧',distractors:['📸','🐸','⭐']},
    {word:'FOCA',   emoji:'🤭',distractors:['🍌','💧','🌙']},
    {word:'GORILA', emoji:'🦍',distractors:['🤭','🍊','🎂']},
  ],
  set5: [
    {word:'CASA',   emoji:'🏠',distractors:['🌹','🎂','🐸']},
    {word:'CUNA',   emoji:'🛏️',distractors:['🏠','🍊','🚀']},
    {word:'COCO',   emoji:'🥥',distractors:['🛏️','🐱','🌙']},
    {word:'BESO',   emoji:'💋',distractors:['🥥','🌸','⭐']},
    {word:'PATO',   emoji:'🦆',distractors:['💋','🐢','🎲']},
    {word:'NUBE',   emoji:'☁️',distractors:['🦆','🍌','🏠']},
    {word:'CAJA',   emoji:'📦',distractors:['☁️','🐸','🎊']},
    {word:'DADO',   emoji:'🎲',distractors:['📦','🌙','🤭']},
  ],
  default: [
    {word:'GATO',   emoji:'🐱',distractors:['🐸','🦁','🌸']},
...
const CONS_ORDER = ['V','M','P','S','L','T','B','N','R'];
...
const BADGES = [
  ...
  {id:'xp500',emoji:'💫',name:{es:'500 XP',en:'500 XP'},
   ...
   check:()=>S.xp>=500},
  {id:'xp1000',emoji:'🔥',name:{es:'1000 XP',en:'1000 XP'},
   desc:{es:'Ganaste 1000 XP — ¡increíble!',en:'Earned 1000 XP — amazing!'},
   check:()=>S.xp>=1000},
  ...
  {id:'master',emoji:'🎓',name:{es:'¡Maestro Lector!',en:'Master Reader!'},
   desc:{es:'Completaste todo el Método Nacho',en:'Completed the full Nacho Method'},
   check:()=>S.badges.includes('lesson_diploma')},
];
...
function launchLesson(id) {
  ...
  S.currentLesson = id;
  S.gameStep    = 0;
  S.gameTotal   = (lesson.game === 'tracing' || lesson.game === 'diploma') ? 1 : 5;
  S.correctCount = 0;
...
function renderGame(gameId) {
  ...
  switch(gameId) {
    ...
    case 'diploma':    renderDiploma();    break;
  }
}
...
function renderDiploma() {
  const body = $('game-body');
  if (!body) return;
  const name = S.name || 'Lector';
  body.innerHTML = `
    <div style="display:flex;flex-direction:column;align-items:center;gap:24px;text-align:center;padding:16px 0">
      <div style="font-size:5rem;animation:bounce 1s ease-in-out infinite alternate">🎓</div>
      <div style="font-size:1.8rem;font-weight:900;background:linear-gradient(90deg,#a78bfa,#fbbf24);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text">
        ¡Felicidades, ${name}!
      </div>
      <div style="font-size:1rem;color:var(--text-2);font-weight:700;max-width:300px;line-height:1.5">
        Completaste el <strong style="color:var(--yellow-l)">Método Nacho</strong> completo.<br>
        ¡Ya sabes leer! 📚✨
      </div>
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:14px;width:100%;max-width:320px">
        <div style="background:var(--bg2);border:1.5px solid rgba(167,139,250,0.3);border-radius:18px;padding:16px 8px">
          <div style="font-size:1.6rem;font-weight:900;color:var(--yellow-l)">${S.xp}</div>
          <div style="font-size:0.75rem;color:var(--muted);font-weight:700">⚡ XP Total</div>
        </div>
        <div style="background:var(--bg2);border:1.5px solid rgba(249,115,22,0.3);border-radius:18px;padding:16px 8px">
          <div style="font-size:1.6rem;font-weight:900;color:var(--streak)">${S.streak}</div>
          <div style="font-size:0.75rem;color:var(--muted);font-weight:700">🔥 Racha</div>
        </div>
        <div style="background:var(--bg2);border:1.5px solid rgba(34,197,94,0.3);border-radius:18px;padding:16px 8px">
          <div style="font-size:1.6rem;font-weight:900;color:var(--green-l)">${S.games}</div>
          <div style="font-size:0.75rem;color:var(--muted);font-weight:700">🎮 Lecciones</div>
        </div>
      </div>
      <div style="font-size:2rem;letter-spacing:6px">🌟🌟🌟🌟🌟</div>
      <button onclick="closeDiploma()" style="
      ...
      ">🔄 Modo Repaso Infinito</button>
    </div>`;

  // Auto-trigger confetti after 400ms
  setTimeout(() => { launchConfetti(); launchConfetti(); }, 400);
  speak(`¡Felicidades ${name}! Completaste el método Nacho. ¡Ya sabes leer!`);
}

function closeDiploma() {
  // Mark all lessons as relockable / go to infinite review mode
  S.currentLesson = null;
  goHome();
  // Show review mode notice
  setTimeout(() => {
    const node = document.querySelector('.lesson-node.active, .lesson-node.completed');
